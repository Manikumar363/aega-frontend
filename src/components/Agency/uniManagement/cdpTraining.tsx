...
export default function CDPTraining({ targetId, targetType = "university" }: CDPTrainingProps) {
    ...
    const fetchCdpProgress = async () => {
      ...
      try {
        ...
        const res = await fetch(
          `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/admin/cdp-courses/enrolled?${queryParams.toString()}`,
          {
            headers: {
