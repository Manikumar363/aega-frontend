...
const UniManagementHome: React.FC = () => {
	...
	const totalEntries = universities.length;
	...
	return (
		<div className="space-y-4 relative">
			...
			{loading ? (
				...
				<div className="border border-[#6A708D] p-8 text-center">
					<p className="text-white/70">
						{universities.length === 0 ? "No universities found." : "No results match your search."}
					</p>
				</div>
			) : (
				<>
					...
					<div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
						...
						<div className="flex items-center gap-3">
							<span className="text-white/70 text-xs">
								Showing {startIndex + 1} to {Math.min(currentPage * entriesPerPage, totalEntries)} of {totalEntries} entries
							</span>
