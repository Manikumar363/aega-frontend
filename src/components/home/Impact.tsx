  ...
  const points = Array.isArray(data?.points) ? data.points : [
    {
      ...
      description: "We aim to become the world's leading alliance, making AEGA membership the trusted benchmark for recruitment integrity and sponsor compliance.",
    },
    {
      title: "TRANSFORM THE INDUSTRY",
      description: "We envision a future where every recruitment agent and educational sponsor operates with the tools and insights necessary for excellence.",
    },
    {
      title: "EMPOWER THROUGH CONFIDENCE",
      description: "We strive to equip our partners to facilitate smooth, compliant, and enriching educational experiences for students worldwide.",
    },
  ];
  ...
  return (
    <section className="w-full bg-[#0A1628] py-16">
      <div className="mx-auto max-w-7xl px-6 md:px-10">
        ...
        {/* Banner Image */}
        <div className="relative mb-12 overflow-hidden shadow-2xl rounded-lg aspect-[7/2]">
          <img
            src={imageSrc}
            alt="Our Mission"
