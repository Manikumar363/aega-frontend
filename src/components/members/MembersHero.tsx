...
export default function MembersHero({ data }: MembersHeroProps) {
  const title = data?.title || "FOR MEMBERS";
  const description = data?.description || "Access comprehensive training, compliance resources, and professional development tools to elevate your practice and build credibility.";
